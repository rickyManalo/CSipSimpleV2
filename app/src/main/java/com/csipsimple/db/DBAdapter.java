...
public class DBAdapter {
	...
	public static class DatabaseHelper extends SQLiteOpenHelper {
		...
		// Match or replace
		private static final String TABLE_FILTERS_CREATE = new StringBuilder()
				.append("CREATE TABLE IF NOT EXISTS ")
				.append(SipManager.FILTERS_TABLE_NAME)
				.append(" (")
				.append(Filter._ID).append(" INTEGER PRIMARY KEY AUTOINCREMENT,")
				.append(Filter.FIELD_PRIORITY).append(" INTEGER,")
				.append(Filter.FIELD_ACCOUNT).append(" INTEGER,")// Foreign key to account
				.append(Filter.FIELD_MATCHES).append(" TEXT,")// Match/replace
				.append(Filter.FIELD_REPLACE).append(" TEXT,")
				.append(Filter.FIELD_ACTION).append(" INTEGER")
				.append(");")
				.toString();

...
public class Sipgate extends AlternateServerImplementation {
	...
	public void fillLayout(final SipProfile account) {
        ...
        if(accountProxy == null) {
            accountProxy = new EditTextPreference(ctx);
		...
		customWizardText = parent.findViewById(R.id.custom_wizard_text);
		customWizard = parent.findViewById(R.id.custom_wizard_row);

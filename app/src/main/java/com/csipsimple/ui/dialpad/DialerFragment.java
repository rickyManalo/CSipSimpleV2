...
public class DialerFragment extends Fragment implements OnClickListener, OnLongClickListener,
    ...
    */
    ...
    private RelativeLayout lytCallFrontDesk;
    private ImageView imgCallFrontDeskIcon;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        */
        ...
        digits = v.findViewById(R.id.digitsText);
        dialPad = v.findViewById(R.id.dialPad);
        callBar = v.findViewById(R.id.dialerCallBar);
        autoCompleteList = v.findViewById(R.id.autoCompleteList);
        rewriteTextInfo = v.findViewById(R.id.rewriteTextInfo);

        lytCallFrontDesk = v.findViewById(R.id.lytCallFrontDesk);
        imgCallFrontDeskIcon = v.findViewById(R.id.imgDialerDigitCall);

        accountChooserButton = v.findViewById(R.id.accountChooserButton);

        accountChooserButton.setVisibility(View.GONE);
        ...
        dialerLayout = v.findViewById(R.id.top_digit_dialer);
        ...
        lytCallFrontDesk.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                guestServiceCallSpeedDial(view);
            }
        });
    ...
    //Speed dial function
    public void guestServiceCallSpeedDial(View v) {
        Log.d("ricky", "speed dial");
        setTextFieldValue("1201");//front desk csip number
        placeCall();
    }
    ...
    private void attachButtonListener(View v, int id, boolean longAttach) {
        ImageView button = v.findViewById(id);
        if (button == null) {
    ...
    public void onCreateOptionsMenu(android.view.Menu menu, android.view.MenuInflater inflater) {
        ...
        android.view.MenuItem delMenu = menu.add(isDigit ? R.string.switch_to_text : R.string.switch_to_digit);
        delMenu.setIcon(
                isDigit ? R.drawable.ic_menu_switch_txt
                        : R.drawable.ic_menu_switch_digit).setShowAsAction(action);
        delMenu.setOnMenuItemClickListener(new android.view.MenuItem.OnMenuItemClickListener() {
            @Override

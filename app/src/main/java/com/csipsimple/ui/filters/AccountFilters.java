...
public class AccountFilters extends SherlockFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "AccountFilters onCreate");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        return false;*/
        Log.d(TAG, "AccntFilters onOptionsItemSelected");
        switch (item.getItemId()) {
            case R.id.home:
                Toast.makeText(getApplicationContext(), "AccntFilters actionBar back pressed", Toast.LENGTH_LONG).show();
                onBackPressed();
                return true;
        }

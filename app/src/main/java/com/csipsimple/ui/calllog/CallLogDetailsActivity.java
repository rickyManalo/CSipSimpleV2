...
public class CallLogDetailsActivity extends SherlockFragmentActivity implements OnQuitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d(TAG, "CallLogDetailsActivity onCreate");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    ...
	    Log.d(TAG, "CallLogDetailsActivity onOptionsItemSelected");
		switch (item.getItemId()) {
			case R.id.home:
				Toast.makeText(getApplicationContext(), "CallLogDetailsAct actionBar back pressed", Toast.LENGTH_LONG).show();
				onBackPressed();
				return true;
		}
		return super.onOptionsItemSelected(item);

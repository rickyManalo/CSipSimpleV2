...
public class SipHome extends AppCompatActivity implements OnWarningChanged {
    ...
    private android.app.ActionBar.Tab warningTab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.app.ActionBar.Tab dialerTab = ab.newTab()
        ...
        mTabsAdapter = new TabsAdapter(ctx, getActionBar(), mViewPager);
    ...
    private class TabsAdapter extends FragmentPagerAdapter implements
        ...
        public TabsAdapter(Context context, android.app.ActionBar actionBar, ViewPager pager) {
        ...
        public void addTab(android.app.ActionBar.Tab tab, Class<?> clss, int tabId) {
            ...
            mActionBar.addTab(tab.setTabListener(tabListener));
    ...
    private Fragment getFragmentAt(int position) {
        ...
        if(id != null) {
            if (id == TAB_ID_DIALER) {
                ...
                Fragment favFrag = new FavListFragment();
                return favFrag;
    ...
    private void postStartSipService() {
        ...
        if (!hasTriedOnceActivateAcc) {
            ...
            Log.d(TAG, "SipHome change activity");
            if (accountCount == 0) {
                ...
                if (distribWizard != null) {
                    ...
                    Log.d(TAG, "SipHome change activity2");
    ...
    private void selectTabWithAction(Intent intent) {
        if (intent != null) {
            ...
            if (!TextUtils.isEmpty(callAction)) {
                android.app.ActionBar ab = getActionBar();
                android.app.ActionBar.Tab toSelectTab = null;
    ...
    public boolean onCreateOptionsMenu(android.view.Menu menu) {
        getMenuInflater().inflate(R.menu.sip_home_menu, menu);
    ...
    public boolean onOptionsItemSelected(android.view.MenuItem item) {
        switch (item.getItemId()) {
            case R.id.sip_home_menu_accounts:

                View v = getLayoutInflater().inflate(R.layout.dlg_password_input, null);

                final EditText txtPassword = v.findViewById(R.id.txtPassword);

                AlertDialog.Builder dlgBuild = new AlertDialog.Builder(SipHome.this);
                dlgBuild.setView(v);
                dlgBuild.setTitle("Enter admin password");
                dlgBuild.setPositiveButton("Ok", null);
                dlgBuild.setNegativeButton("Cancel", null);

                final AlertDialog dlg = dlgBuild.create();
                    ...
                    public void onShow(DialogInterface dialogInterface) {
                        ...
                        btnOk.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                boolean codeOk = validateCode(txtPassword.getText().toString());

                                if(!codeOk){
                                    Toast.makeText(getApplicationContext(), "Password invalid", Toast.LENGTH_LONG).show();
                                }else{
                                    dlg.dismiss();
                                    startActivity(new Intent(getApplicationContext(), AccountsEditList.class));
                                }
                            }
                        });
    ...
    private boolean validateCode(String s) {
        String currentPassword = "123456";
        String inputtedPassword = s;

        if(inputtedPassword.equals(currentPassword)){
            return true;
        }else{
            return false;
        }
    ...
    public void onBackPressed() {
        ...
        try{
            ...
            Toast.makeText(getApplicationContext(), "App doesn't exist", Toast.LENGTH_LONG).show();
        }

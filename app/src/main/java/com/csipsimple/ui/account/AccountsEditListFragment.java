...
public class AccountsEditListFragment extends CSSListFragment implements /*OnQuitListener,*/ OnCheckedRowListener{
	...
	class AccountStatusContentObserver extends ContentObserver {
		...
		public void onChange(boolean selfChange) {
			...
			Log.d(TAG, "accntEditLstFrag accounts status onChange");
		}
	}
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "accntEditLstFrag onCreate");
	}
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "accntEditLstFrag activity created");
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        Log.d(TAG, "accntEditLstFrag create options mneu");
        ...
        menu.add(R.string.backup_restore).setIcon(android.R.drawable.ic_menu_save)
                .setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        final String[] fItems = items.toArray(new String[0]);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d(TAG, "AccntEditLstFrag onCreateView");
        // Use custom drag and drop view
        View v = inflater.inflate(R.layout.accounts_edit_list, container, false);
        
        final DragnDropListView lv = v.findViewById(android.R.id.list);
        ...
        lv.setOnDropListener(new DropListener() {
            ...
            public void drop(int from, int to) {
                ...
                ArrayList<Long> orderedList = new ArrayList<>();
        ...
        // Empty view
        Button bt = v.findViewById(android.R.id.empty);
    ...
    private void updateCheckedItem() {
        Log.d(TAG, "accntEditLstFrag update checked item");
    ...
    public void onResume() {
        Log.d(TAG, "accountsEditListFragment");
    	super.onResume();
    ...
    public void onPause() {
    	super.onPause();
        Log.d(TAG, "accntEditLstFrag onPause");
    	if(statusObserver != null) {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        Log.d(TAG, "accntEditLstFrag lst item click");
    ...
    private void showDetails(long profileId, String wizard) {
        ...
        Log.d(TAG, "accntEditLstFrag show details");
        /*
    	if (dualPane) {
	...
	*/
	...
	public void onToggleRow(AccountRowTag tag) {
        Log.d(TAG, "accntEditLstFrag onToggleRow");
		ContentValues cv = new ContentValues();
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        Log.d(TAG, "accntEditLstFrag createLoader");
	...
	public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        Log.d(TAG, "accntEditLstFrag loadFinish");
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.d(TAG, "accntEditLstFrag onActivityResult");
     ...
     * @param cmi The context menu info to retrieve info from

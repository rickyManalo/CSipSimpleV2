...
public class AccountsEditListAdapter extends SimpleCursorAdapter implements OnClickListener {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        //TODO: maybe need to fix this for showing text in setup
        ...
        tagView.labelView.setVisibility(View.VISIBLE);
        ...
        if (account.active) {
            ...
            tagView.labelView.setTextColor(context.getResources().getColor(

...
public class ActionBarView extends AbsActionBarView {
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        mNavigationMode = a.getInt(R.styleable.SherlockActionBar_mNavigationMode,
        ...
        setDisplayOptions(a.getInt(R.styleable.SherlockActionBar_mDisplayOptions, DISPLAY_DEFAULT));
